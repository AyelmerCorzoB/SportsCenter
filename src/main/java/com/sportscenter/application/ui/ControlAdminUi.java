...
public class ControlAdminUi {
    ...
    private void printMainMenuOptions() {
        ConsoleUtils.clear();
        System.out.println("\n PANEL DE CONTROL ADMIN - PÁGINA " + currentPage);
        if (currentPage == 1) {
            printPage1Options();
        } else {
            printPage2Options();
    ...
    private void printPage1Options() {
        ...
        System.out.println("7. Salir a menú principal");
    }
    ...
    private void manageProducts() {
        ...
        ProductUI.manejarMenuProduct(scanner, useCase);
    }
    ...
    private void manageSuppliers() {
        ...
        SupplierUI.manejarMenuSupplier(scanner, useCase);
    }
    ...
    private void manageSales() {
        ...
        SaleUI.manejarMenuSale(scanner, useCase, saleDetailUseCase);
    }
    ...
    private void manageEmployees() {
        ...
        EmployeeUI.manejarMenuEmployee(scanner, useCase);
    }
