...
public class ControlAdminUi {
    ...
    private void manageCustomerTypes() {
        ...
        CustomerTypeUI customerTypeUI = new CustomerTypeUI();
        customerTypeUI.mostrarMenu();
    }
    ...
    private void manageProducts() {
        ...
        ProductUI productUI = new ProductUI(scanner, useCase);
